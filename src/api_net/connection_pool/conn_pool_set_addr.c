...
int ap_net_set_str_addr(int af, void *destination, const char *address_str, socklen_t addr_len, int port)
{
	...
	DEBUGMSG(1,("shell sin_addr:%s, sin_port:%d\r\n", inet_ntoa(((struct sockaddr_in*)&destination)->sin_addr), port));
