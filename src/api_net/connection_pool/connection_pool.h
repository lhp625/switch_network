...
//#define AP_NET_ST_RECONNECTION  128
...
#define AP_NET_SIGNAL_CONN_PACK  	  11
...
typedef struct ap_net_connection_t
{
	...
	BYTE recebuf[BUFFER_LEN_10K]; /**< Incoming data buffer. */
...
typedef struct
{
	ap_net_conn_pool_t* (*ConnectionPoolCreate)(int, int, int, int, ap_net_conn_pool_callback_func);
	int (*ConnectionPoolSetStrAddr)(struct ap_net_conn_pool_t *, const char *, int);
	int (*ConnectionPoolListenerCreate)(struct ap_net_conn_pool_t *, int, int);
	int (*ConnectionPoolPoll)(struct ap_net_conn_pool_t *);
	int (*ConnectionPoolSend)(struct ap_net_conn_pool_t *, int, void *, int);
	void (*ConnectionPoolClose)(struct ap_net_conn_pool_t *, int);
	int (*ConnectionPoolSetAddr)(struct sockaddr_in *, in_addr_t, int);
	void (*ConnectionPoolDestroy)(struct ap_net_conn_pool_t *, int);
	ap_net_connection_t* (*ConnectionPoolConnect)(struct ap_net_conn_pool_t *, unsigned, const char *, int, int, int);
	int (*ConnectionPoolpollerCreate)(struct ap_net_conn_pool_t *);
}structApiNetTCP;
